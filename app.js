...
mongoose.connect("mongodb+srv://dbUser:Raj1234@cluster0.ltgyg.mongodb.net/todolistDB", {useNewUrlParser: true,useUnifiedTopology: true });
...
const item1 = new Item({
  name: "Welcome to WebDev!"
});

const item2 = new Item({
  name: "How to create a ToDoList."
});
